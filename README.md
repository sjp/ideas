...
**Update** This is implemented in [BaGet](https://github.com/loic-sharma/BaGet).
...
**Update**: [DocFX](https://github.com/dotnet/docfx) fits the bill here. However, what would be nice is porting the Rust theming and behaviour over to DocFX.
...
**Update** [lufi](https://git.framasoft.org/luc/lufi), among others listed [here](https://github.com/awesome-selfhosted/awesome-selfhosted) implement this behaviour.
